...
sleep(200).then(() => {
    ...
    if (document.querySelector(activeTab + '.line.clan .statblock-markdown') != null && (statblockCSSclass.endsWith('.vtm-v20-vampire') || statblockCSSclass.endsWith('.vtm-v20-vampire-en') || statblockCSSclass.endsWith('.vtm-v20-vampire-es'))) {
        // define clan
    ...
    if (document.querySelector(statblockCSSpathHover + '.line.clan .statblock-markdown') != null && (statblockCSSclassHover.endsWith('.vtm-v20-vampire') || statblockCSSclassHover.endsWith('.vtm-v20-vampire-en') || statblockCSSclassHover.endsWith('.vtm-v20-vampire-es'))) {
    ...
    if (document.querySelector(activeTab + '.line.clan .statblock-markdown') != null && (statblockCSSclass.endsWith('.vtm-v20-vampire-dark-ages') || statblockCSSclass.endsWith('.vtm-v20-vampire-dark-ages-en') || statblockCSSclass.endsWith('.vtm-v20-vampire-dark-ages-es'))) {
        // define clan
        var clanName = document.querySelector(activeTab + '.line.clan .statblock-markdown > p').innerHTML;
    ...
    // same code, but for a statblock in hover
    if (document.querySelector(statblockCSSpathHover + '.line.clan .statblock-markdown') != null && (statblockCSSclassHover.endsWith('.vtm-v20-vampire-dark-ages') || statblockCSSclassHover.endsWith('.vtm-v20-vampire-dark-ages-en') || statblockCSSclassHover.endsWith('.vtm-v20-vampire-dark-ages-es'))) {
        var clanNameHover = document.querySelector(statblockCSSpathHover + ' .line.clan .statblock-markdown > p').innerHTML;
        var collapsedColumnHover = document.querySelector(statblockCSSpathHover + ' .collapse-container');
        switch (clanNameHover) {
            case 'Assamite':
    ...
    if (document.querySelector(activeTab + '.line.tribe .statblock-markdown') != null && (statblockCSSclass.endsWith('.wta-w20-werewolf') || statblockCSSclass.endsWith('.wta-w20-werewolf-en') || statblockCSSclass.endsWith('.wta-w20-werewolf-es'))) {
        // define tribe
    ...
    if (document.querySelector(activeTab + '.line.affiliation .statblock-markdown') != null && (statblockCSSclass.endsWith('.mta-m20-mage') || statblockCSSclass.endsWith('.mta-m20-mage-en') || statblockCSSclass.endsWith('.mta-m20-mage-es'))) {
        // define affiliation
    ...
    // same code, but for a statblock in hover
    if (document.querySelector(statblockCSSpathHover + '.line.affiliation .statblock-markdown') != null && (statblockCSSclassHover.endsWith('.mta-m20-mage') || statblockCSSclassHover.endsWith('.mta-m20-mage-en') || statblockCSSclassHover.endsWith('.mta-m20-mage-es'))) {
    ...
    if (document.querySelector(activeTab + '.line.affiliation .statblock-markdown') != null && (statblockCSSclass.endsWith('.mta-m20-technocrat') || statblockCSSclass.endsWith('.mta-m20-technocrat-en') || statblockCSSclass.endsWith('.mta-m20-technocrat-es'))) {
        // define affiliation
        var affiliationName = document.querySelector(activeTab + '.line.affiliation .statblock-markdown > p').innerHTML;
        console.log(affiliationName + ' - название секты')
        // define the area where a tribe image should be placed
